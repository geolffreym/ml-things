...
def ModelLearning(X, y, max_depth=[1, 3, 6, 10]):
...
def ModelComplexity(X, y, max_depth=np.arange(1, 11)):
    ...
    pl.title('Decision Tree Complexity Performance')
